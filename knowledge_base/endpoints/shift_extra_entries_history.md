# Shift Extra Entries History

- **Function:** `get_shift_extra_entries_history` (in `src/shift_extra_entries_history/api.py`)
- **HTTP path:** `/shift_extra_entries/history/` (full URL = `${RHUMBIX_BASE_URL}/shift_extra_entries/history/`)
...
```python
rows = get_shift_extra_entries_history(history_type="UPDATED", history_start_date="2024-01-01")
```
