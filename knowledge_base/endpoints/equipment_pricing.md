...
- **Function:** `get_equipment_pricing` (in `src/equipment_pricing/api.py`)
- **HTTP path:** `/equipment_pricing/` (full URL = `${RHUMBIX_BASE_URL}/equipment_pricing/`)
