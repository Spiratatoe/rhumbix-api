...
SHIFT_EXTRA_ENTRIES_HISTORY_ENDPOINT = "/shift_extra_entries/history/"

def get_shift_extra_entries_history(
    ...
    """
    Retrieves a list of shift extra entry history records from the Rhumbix API.
    ...
    Returns:
        List[Dict]: A list of shift extra entry history dictionaries.
    """
    url = f"{BASE_URL}{SHIFT_EXTRA_ENTRIES_HISTORY_ENDPOINT}"
