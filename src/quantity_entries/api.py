...
QUANTITY_ENTRIES_ENDPOINT = "/quantity_entries/"

def get_quantity_entries(
    ...
    """
    Retrieves a list of quantity entries from the Rhumbix API.
    ...
    Returns:
        List[Dict]: A list of quantity entry dictionaries.
    """
    url = f"{BASE_URL}{QUANTITY_ENTRIES_ENDPOINT}"
