...
ABSENCES_HISTORY_ENDPOINT = "/absences/history/"

def get_absences_history(
    ...
    """
    Retrieves a list of absence history records from the Rhumbix API.

    Args:
        page_size (Optional[int]): Number of results to return per page.
        ids (Optional[List[int]]): Filter by one or more absence IDs.
    ...
    Returns:
        List[Dict]: A list of absence history dictionaries.
    """
    url = f"{BASE_URL}{ABSENCES_HISTORY_ENDPOINT}"
